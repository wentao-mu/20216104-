...
insert into author values('20216104','mwt');
insert into author values('20216103','mrq');
insert into author values('szh','szh');

insert into pa(authorname,authorrank,authoridentity,authortype,paperid) values('mwt',1,'普通作者','本院教师',1);
insert into pa(authorname,authorrank,authoridentity,authortype,paperid) values('mrq',2,'普通作者','本院学生',1);
